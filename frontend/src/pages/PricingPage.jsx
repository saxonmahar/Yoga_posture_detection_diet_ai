...
import { Check, Star, Zap, Users, Target, Award } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {plans.map((plan, index) => (
            <div key={index} className="relative">
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-sm font-bold rounded-full">
                  MOST POPULAR
                </div>
              )}
              
              <div className={`bg-card/50 backdrop-blur-sm rounded-2xl border ${plan.popular ? 'border-yellow-500/50' : 'border-white/10'} p-8 h-full`}>
