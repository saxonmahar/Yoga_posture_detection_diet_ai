...
// Existing Routes - Note: These are relative to /api/pose
...
// New MediaPipe AI Pose Detection Routes
router.post('/detect-mediapipe', poseController.detectPoseWithMediaPipe); // POST /api/pose/detect-mediapipe
router.post('/realtime-detection', poseController.startRealTimePoseDetection); // POST /api/pose/realtime-detection
